...
export const keilSidebarMenu: NavItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { title: "Attendance Summary", path: "/keil/hr-payroll/reports/attendance", permissionKey: "hr_attendance_summary_view" },
        ]
    },
    {
    ...
    },
    {
        ...
        children: [
            ...
            { title: "Daily Collection report", path: "/keil/operations/collection", permissionKey: "prod_collection_view" },
    ...
    },
    {
        ...
        children: [
            ...
            { title: "Tripsheet", path: "/keil/fleet/logs", permissionKey: "fleet_log_view" },
            ...
            { title: "Fuel Filling", path: "/keil/fleet/fuel", permissionKey: "fleet_fuel_view" }
        ]
    },
    {
