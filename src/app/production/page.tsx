    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
      <div className="flex justify-between items-end">
        <div>
          ...
          <p className="text-foreground/60 mt-1">Monitor manufacturing processes and machine statuses.</p>
        </div>
      ...
      <Card className="h-96 shadow-sm border-border/50">
        <CardContent className="h-full flex items-center justify-center p-6">
          <p className="text-foreground/40 font-medium">Production Overview</p>
        </CardContent>
      </Card>
    </div>
  );
